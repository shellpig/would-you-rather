...
> (咖啡/茶)沿用 demo 圖已轉 WebP 落地 `public/img/daily-life/`(latte.webp 46KB、tea.webp 36KB)。
> 選項圖整體進度:30 張需 4 張有原始圖、2 張已落地前端,其餘 12 題 24 張與封面待生成
> (第 7 題註記的既有鬧鐘/月亮燈圖 repo 內不存在,沿用前需確認來源)。
