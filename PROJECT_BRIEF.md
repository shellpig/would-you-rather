...
> `驗證後已知問題.md`。
> 第 1–15 題共 30 張選項圖與封面(雙門夏冬構圖)已全數落地 `public/img/daily-life/`;demo 題庫資源已被正式庫全面取代,
> 後續可下架(檢查清單既有項)。種子票分佈 15 題已定稿(2026-07-16,見題庫文件);daily-life 尚缺:
> 題庫 JSON 接前端、seed script、標題/簡述/OG 文案定稿、demo 下架。
