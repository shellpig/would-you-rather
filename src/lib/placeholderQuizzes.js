 ...
 * @param {{id:string,title:string,cover?:string,icon?:string}} quiz
 */
export function renderPlaceholderCard(quiz) {
  ...
  const coverClass = quiz.cover ? " quiz-card--placeholder-with-cover" : "";

  return `
    <div class="quiz-card quiz-card--placeholder${coverClass}" aria-disabled="true">
      ${cover}
